...
class Basic : Fragment(),ItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val kutu6 = Product(getString(R.string.kargokutusu),15.5,17.0,6.5,15.00,getString(R.string.icerik),getString(R.string.kargokutusu),"SBP2223","TST E","","15,2x15,5x6,5","altibir","altıiki")
        val kutu7 = Product(getString(R.string.kargokutusu),21.3,13.3,4.7,15.00,getString(R.string.icerik),getString(R.string.kargokutusu),"SBP2221","TST E","","13x20x,47","yedibir","yediiki")
        val kutu8 = Product(getString(R.string.kargokutusu),15.0,11.0,3.3,9.00,getString(R.string.icerik),getString(R.string.kargokutusu),"SBP2222","TST E","","10,8x14x3,3","sekizbir","sekiziki")
        val kutu9 = Product(getString(R.string.lock),23.0,15.5,11.5,17.00,getString(R.string.icerik),getString(R.string.kargokutusu),"SBP2220","TST","Bu ürün en çok hamburger kutusu olarak tercih edilmektedir","12,3x22,8x11,3","dokuzbir","dokuziki")
        ...
        val kutu15 = Product(getString(R.string.lock),11.0,4.7,6.0,20.00,getString(R.string.icerik),getString(R.string.lock),"SBP2214","TST E/BST E","","3,8x9,3x8,3","onbesbir","onbesiki")
